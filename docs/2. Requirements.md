...
| USE-CASE UC1 | Find nearest Toilet |   <!-- Eryk Szymanski -->
| -------------------------------------- | ------------------- |
...
| USE-CASE UC2 | Find a toilet with baby changing |   <!-- Eryk Szymanski -->
| -------------------------------------- | ------------------- |
...
| USE-CASE UC3 | Provide directions to the nearest toilet |   <!-- Eryk Szymanski -->
| -------------------------------------- | ------------------- |
